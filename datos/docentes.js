const docentes = [
    {
        nombre: "ADA LIZETH ORDOÑEZ MARTINEZ",
    ...
    {
        nombre: "EDWIN GEOVANNY RAUDALES LANZA",
        cargo: "Desarrolla en el Taller de Madera",
        resena: "Nacido en Tegucigalpa el 22 de Julio de 1983. Docente especializado en el área de madera, con lapso avanzado ya de tiempo de formar parte de la institución. Se caracteriza por su compromiso, responsabilidad y dedicación en la enseñanza práctica, promoviendo el aprendizaje, la seguridad y el desarrollo de habilidades técnicas en sus estudiantes.",
        proyectos: "Tuvo su formación en Carpintería y Ebanisteria y actualmente cursando la carrera de Educación Tecnológica orientada en Madera en la UPNFM",
        foto: "../img/Edwin Geovani Raudales Lanza.png"
    },
    ...
    {
        nombre: "FATIMA YANETH RODRIGUEZ",
        cargo: "Docente de Educación Media, coordinadora de TES y encargada de realizar funciones de consejería (HRAS).",
        resena: "La profesora Fátima Yaneth Rodríguez tiene 56 años y 18 años de servicio en el instituto. Durante su trayectoria ha compartido conocimientos y experiencias con sus estudiantes, manteniendo una excelente relación tanto con ellos como con sus compañeros de trabajo. Se considera una docente responsable, comprometida y con gran capacidad profesional.",
        proyectos: "Coordinación del programa TES.\nParticipación en actividades de consejería estudiantil (HRAS).\nImpartición de las asignaturas de:\nAdministración General.\nGestión Empresarial.\nEconomía.\nLegislación.",
        foto: "../img/Profe Fátima.jpg"
    },
...

    {
        ...
        {
        nombre: "KATIA PATRICIA OSORTO GALO",
        cargo: "Asistente de Secretaría y docente de Inglés y Educación Primaria",
        resena: "Katia Patricia Osorto Galo es una destacada educadora con una sólida trayectoria de más de tres décadas dedicada a la formación integral de la niñez y la juventud hondureña. Su carrera se caracteriza por la versatilidad y el compromiso, transitando con éxito desde la educación primaria —donde ejerce desde 1991 en el Centro Educativo Lennart Ostlund— hasta la enseñanza del idioma inglés y la gestión administrativa en el nivel medio en el Instituto Técnico Francisco Miranda.\n\nSu perfil combina una sólida vocación pedagógica con competencias organizativas de alto nivel, lo que le ha permitido asumir con éxito responsabilidades como asistente de secretaría y docente titular. Es una profesional respetada por su constancia, ética laboral y su capacidad de adaptación a las demandas educativas del país.",
        proyectos: "Gestión y Modernización Administrativa: Optimización de los procesos de secretaría, control de registros académicos y atención institucional en el Instituto Técnico Francisco Miranda a partir de 2016.\n\nInnovación en la Enseñanza Bilingüe: Implementación de metodologías comunicativas y dinámicas para la enseñanza del inglés, adaptadas a los niveles de educación media técnica desde 2004.\n\nFormación Integral en Educación Básica: Desarrollo y ejecución de planes de estudio enfocados en la lectoescritura, valores y competencias fundamentales en el nivel primario durante más de tres décadas.",
        foto: "../img/Katia Patricia Osorto Galo.jpg"
    },

    {
        nombre: "LESBY ELIETH MEDINA AGURCIA",
        cargo: "Secretaria General del Instituto Gubernamental Técnico Francisco Miranda",
        resena: "Profesional de la educación hondureña con más de 20 años de destacada trayectoria en la administración y gestión educativa de nivel medio. A lo largo de su carrera ha ejercido como Secretaria General en instituciones públicas y privadas, caracterizándose por un alto sentido de ética, liderazgo y compromiso organizativo. Su labor ha sido fundamental para el crecimiento institucional, velando por la eficiente administración documental, la ampliación de la cobertura escolar, la actualización de los planes de estudio y el bienestar social del equipo docente y administrativo.",
        proyectos: "Gestión y trámite para afiliar al personal docente y administrativo a los servicios de previsión social.\n\nAmpliación de secciones y apertura de nuevas aulas en el ciclo básico de séptimo, octavo y noveno grado.\n\nCreación de las carreras de Informática y Agroindustria, además de la conversión hacia el Bachillerato Técnico Profesional y Contaduría y Finanzas.\n\nCoordinación y distribución de la carga horaria del personal docente según sus contratos y antigüedad institucional.",
        foto: "../img/Elieth Medina.jpg"
    },

    {
        nombre: "LUIS EDUARDO SALGADO BENITEZ",
        cargo: "Docente del área de Agroindustria",
        resena: "Luis Eduardo Salgado Benítez se graduó en la Universidad Nacional de Agricultura y Ganadería con el título de Ingeniería Agronómica. Actualmente cuenta con dos años y medio en el instituto.",
        proyectos: "Siembra de maíz y frijoles, crianza de gallinas y cerdos, elaboración de gallineros y corrales. Como proyecto futuro se plantea la creación de una acuaponía, sistema sostenible que combina la cría de peces con el cultivo de plantas en un ciclo cerrado.",
        foto: "../img/Luis Salgado.png"
    },

    {
        nombre: "MARIA DE LA PAZ ALVAREZ YANES",
        cargo: "Docente de servicio estricto y coordinadora de práctica",
        resena: "Originaria del municipio de Alianza, Valle, cursó dos años de estudios en el Instituto Técnico Honduras para luego trasladarse al Instituto Central Vicente Cáceres, donde culminó la secundaria. Posteriormente, realizó sus estudios superiores en la Universidad Pedagógica Nacional Francisco Morazán (UPNFM).",
        proyectos: "Actualmente es coordinadora de práctica del Instituto Técnico Francisco Miranda.",
        foto: "../img/Maria de la Paz Álvarez_.png"
    },

    {
        nombre: "MARIO LEONEL AVILA MARADIAGA",
        cargo: "Docente del área de Electricidad",
        resena: "Docente y pedagogo con formación académica en la carrera de Tecnología Industrial por la Universidad Pedagógica Nacional Francisco Morazán (UPNFM). Apasionado y profundamente comprometido con la formación integral, el bienestar emocional y el desarrollo académico de jóvenes. A lo largo de su trayectoria, se ha caracterizado por impulsar procesos educativos innovadores que combinan el rigor técnico con un enfoque humano y empático.",
        proyectos: "Mantenimiento de electricidad del colegio, tableros de práctica, apoyo a talleres y conocimientos en el área preventiva.",
        foto: "../img/Mario leonel avila maradiaga.png"
    },

    {
        nombre: "MARISABEL ROSALES",
        cargo: "Asistente de Orientación",
        resena: "Docente y pedagoga comprometida con la formación integral, el bienestar emocional y el desarrollo académico de niños, jóvenes y adultos. A lo largo de su trayectoria se ha destacado por enseñar con responsabilidad, respeto y vocación de servicio, promoviendo ambientes inclusivos y basados en el diálogo. Como orientadora, su labor se centra en transformar vidas acompañando a sus estudiantes en la resolución de sus dificultades académicas y personales, fomentando valores, resiliencia y ciudadanía responsable.",
        proyectos: "Escuela para Padres: Organización y desarrollo de talleres para fortalecer la participación activa y el compromiso de las familias en la educación.\n\nGobierno Estudiantil: Coordinación y promoción de la participación democrática y el liderazgo de los alumnos.\n\nActividad del Cine Benefactor: Organización de funciones de cine para recaudar fondos y brindar apoyo económico a estudiantes de escasos recursos.\n\nAtención y Seguimiento Psicopedagógico: Ayuda en la resolución de problemas de aprendizaje y emocionales.\n\nCampañas de Prevención y Talleres: Talleres sobre autoestima, valores, convivencia y prevención de violencia, acoso escolar, consumo de drogas y trata de personas.",
        foto: "../img/Marisabel Rosales_.jpg"
    },

    {
        nombre: "MARLON NOEL IZAGUIRRE VELASQUEZ",
        cargo: "Consejero de Estudiantes y docente de Educación Media en Informática y Agroindustria",
        resena: "Docente y consejero con una destacada trayectoria en el Instituto Francisco Miranda desde el año 2009, fecha en la que colaboró en la cofundación de la jornada vespertina de la institución. Su perfil se caracteriza por un fuerte compromiso con el desarrollo de la comunidad estudiantil y el crecimiento físico del centro educativo, destacando tanto en la labor docente en las áreas de Informática y Agroindustria como en el liderazgo de proyectos de infraestructura, medioambiente y orientación estudiantil.",
        proyectos: "Coordinación y asesoría del T.E.S. durante 10 años consecutivos (2010-2020).\n\nProyectos comunitarios y ambientales: extensión comunitaria, ornato interno del instituto y reforestación en Zambrano y comunidades aledañas.\n\nInfraestructura institucional: construcción del kiosco en la entrada principal, edificación de la cafetería y comedor \"Cafetería Color Azul\", aula taller para Estructuras Metálicas y terrazas y muros de contención frente al edificio administrativo.",
        foto: "../img/Marlon Izaguirre .png"
    },

    {
        nombre: "MAYRA ALEJANDRA MARTINEZ AGUILAR",
        cargo: "Docente en el Área de Español",
        resena: "Completó sus estudios universitarios en la Universidad Pedagógica Nacional Francisco Morazán (UPNFM), donde obtuvo el título de Licenciada en Letras y Lenguas Españolas. Cuenta con una sólida formación académica enfocada en la enseñanza de la lengua, la literatura y el desarrollo lingüístico. Actualmente reside en la Residencial Hacienda Real, en la ciudad de Comayagua.",
        proyectos: "Desarrollo y fortalecimiento de competencias en oratoria y expresión oral, en colaboración con la docente Ada Ordoñez. Este proceso estuvo enfocado en el dominio del discurso, técnicas de comunicación efectiva, manejo de voz y proyección en público.",
        foto: "../img/Docente Mayra Alejandra Martines Aguilar_.jpg"
    },

    {
        nombre: "MIRIAM JANETH ORTEZ NOVOA",
        cargo: "Docente en el área de Ciencias Naturales",
        resena: "La Ing. Miriam Torres se consolida como una educadora e ingeniera de perfil interdisciplinario, al vincular el rigor analítico de la Ingeniería Industrial con la perspectiva ambiental de las Ciencias Naturales. Su labor destaca por conectar el conocimiento académico con los desafíos actuales de la sostenibilidad y la producción agroindustrial.",
        proyectos: "Desarrollo de proyectos de sostenibilidad agroindustrial centrados en la optimización de procesos productivos y la reducción del impacto ambiental. También implementa iniciativas de aprendizaje práctico y programas de mentoría orientados al liderazgo ético y proyectos de transferencia tecnológica.",
        foto: "../img/Miriam Janeth Ortez Novoa.png"
    },

    {
        nombre: "RODYN JAVIER FIGUEROA OSORTO",
        cargo: "Docente en el área de Carpintería y Ebanistería",
        resena: "Cuenta con una sólida formación en ingeniería industrial, metalmecánica, cerámica y metalurgia, además de múltiples certificaciones técnicas. Con cerca de 48 años de trayectoria docente en la institución, imparte clases en el ciclo básico en áreas técnicas como carpintería y dibujo. Paralelamente a su labor educativa, se desempeña como emprendedor agrícola con su marca de chiles habaneros.",
        proyectos: "Espíritu emprendedor enfocado en el sector agrícola con el desarrollo de la marca de chiles habaneros \"Habaneros del Valle de Tamara\". Cuenta con trayectoria docente impartiendo talleres técnicos en áreas como carpintería, ebanistería y dibujo técnico.",
        foto: "../img/Rodyn Javier Figueroa Osorto.png"
    },

    {
        nombre: "SANTIAGO HUMBERTO FUNEZ ZUNIGA",
        cargo: "Docente de Educación Física en el nivel de educación media",
        resena: "Docente con una sólida trayectoria de nueve años en la institución, habiendo formado parte de su cuerpo docente desde sus inicios y consolidándose como uno de los maestros con mayor antigüedad y arraigo en la comunidad educativa.",
        proyectos: "Dirección y organización de justas deportivas, destacando la planificación de la maratón atlética institucional —la \"Chagotón\"— y la gestión de campeonatos de fútbol a nivel interno e interinstitucional.",
        foto: "../img/Santiago Funez.png"
    },
    ...
    {
        nombre: "VALESKA YAMILETH MEJIA",
        cargo: "Docente de Educación Media y Orientación",
        resena: "Labora como docente de educación media desde abril de 1998. Ha trabajado en diferentes centros educativos y desde 2013 se encuentra asignada al departamento de Orientación en el Instituto Gubernamental Técnico Francisco Miranda. También ha desempeñado funciones como jefe de talleres, consejera de estudiantes, coordinadora académica y coordinadora y asesora de TES.",
        proyectos: "Participación como promotora del equipamiento del taller de carpintería, contribuyendo significativamente a su desarrollo. También es creadora y propietaria de la marca Kakawa Chocolates, registrada bajo la empresa De Cacao Chocolates, dedicada a la transformación y comercialización de productos derivados del cacao.",
        foto: "../img/Valeska Yamileth Mejia.png"
    },

    {
        nombre: "VANESSA LIZETH GALINDO VELASQUEZ",
        cargo: "Docente en el área de Taller de Estructuras Metálicas y Dibujo Técnico",
        resena: "Durante su etapa en la Normal Mixta disfrutó de sus seis años de colegio y participó activamente en diferentes actividades, como el grupo de marimba y cursos de economía.",
        proyectos: "Proyecto personal: logró la meta de comprar y construir su propia casa en Tegucigalpa. Proyecto institucional: elaboración de bancas utilizando material de desecho y reciclaje.",
        foto: "../img/Vanessa Lizeth galindo Velasquez.png"
    },

    {
        nombre: "WENDY PATRICIA ANDINO AMADOR",
        cargo: "Docente en el área de Ciencias Sociales",
        resena: "Ha desempeñado diferentes funciones dentro del ámbito educativo, incluyendo dirección, secretaría y docencia. Ha trabajado en instituciones como el Instituto Santa Mónica y ha ejercido funciones de coordinación de Administración de Empresas, además de desempeñarse como docente universitaria.",
        proyectos: "Participación activa en el Movimiento Juventud, contribuyendo al fortalecimiento del liderazgo juvenil y la formación integral de los estudiantes. También ha impulsado iniciativas para proyectar y dar a conocer al instituto a nivel nacional e internacional y ha brindado apoyo al proyecto \"¡Viva la Juventud!\".",
        foto: "../img/Wendy Patricia Andino Amador.jpeg"
    },

    {
        nombre: "WILMER JAVIER AGUILAR DOMINGUEZ",
        cargo: "Docente y encargado de la carrera de Informática",
        resena: "Durante su formación en la Universidad Pedagógica demostró un firme compromiso con su desarrollo profesional y académico. Gracias a su dedicación, esfuerzo constante y al apoyo de sus padres, logró culminar su carrera universitaria en un período de cuatro años y medio, alcanzando una de las metas más importantes de su vida profesional.",
        proyectos: "Ha colaborado en la gestión de Bienes Nacionales y lideró la creación del Laboratorio de Robótica de la institución. También ha contribuido al desarrollo y fortalecimiento de la carrera de Informática mediante nuevas metodologías, experiencias de aprendizaje y tecnologías innovadoras. Además, ha promovido la participación de los estudiantes en Ferias de Ciencias, logrando que la institución alcanzara por primera vez la etapa distrital.",
        foto: "../img/Wilmer Javier Aguilar Dominguez.jpeg"
    },

    {
        nombre: "WILMER ALEXIS GUEVARA CARDENAS",
        cargo: "Docente de Ciencias Naturales, Biología, Química y Física",
        resena: "Alexis Guevara Cárdenas es docente de Ciencias Naturales en la institución, con 18 años de trayectoria acompañando a los estudiantes de décimo grado. Es Biólogo y Licenciado en Ciencias Naturales con especialidad en Biología y Química. Durante su carrera ha dictado las áreas de Biología, Química y Física, aportando una visión integral de las ciencias. Su compromiso ha sido formar estudiantes curiosos, críticos y con amor por la naturaleza y el método científico.",
        proyectos: "Laboratorio Vivo de Ciencias: espacio para que los estudiantes de décimo realicen prácticas de biología, química y física.\n\nFeria Ambiental y Científica: proyecto anual donde los alumnos presentan investigaciones sobre ecosistemas locales, contaminación y energías.",
        foto: "../img/wilmer Alexis Guebara Cardenas.png"
    },

    {
        nombre: "DANILO JOSÉ BANEGAS FIGUEROA",
